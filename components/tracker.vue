...
<g>
        ...
        multiLine
        >
<svg height="20px" width="20px" class="mr-2" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            if(checks == -1){
                ...
                const check_wallet_if_exist_then_save = await this.WalletInfo(info.wallet)
                    if(typeof check_wallet_if_exist_then_save == "boolean"){
                        //Cannot Find Wallet
                        this.snackbar = true
                        this.failed = "Ronin wallet has no data to display"
